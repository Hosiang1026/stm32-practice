...
void Redraw_Mainmenu(void)
{
	...
	Gui_DrawFont_GBK16(16,0,BLUE,GRAY0,"狂欢马克思");
...
void Font_Test(void)
{
	...
	delay_ms(1000);
	Lcd_Clear(GRAY0);
	Gui_DrawFont_GBK16(16,30,YELLOW,GRAY0,"伟大复兴");
	Gui_DrawFont_GBK16(16,50,BLUE,GRAY0,"狂欢马克思");
...
//取模方式 水平扫描 从左到右 低位在前
void showimageAll(const unsigned char *p) //显128*160 图片
{
  	long int i; 
	unsigned char picH,picL;
	Lcd_Clear(WHITE); //清屏  
